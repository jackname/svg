...
;(function () {
    ...
    function selectShape(shape, imgStr) {
        ...
        if (shape == 'line') {
            ...
            textId=textId+1;
            selected = svg.paper.text(attrs[0], attrs[1], atext).attr({dataid:strData,id:'text'+textId}).drag();
            // dataid
        } else if (shape == 'image') {
    ...
    function createHandler(shape, name, value) {
        ...
        if (shape == 'line') {
            ...
            odiv.innerHTML = '<label>宽 <input type="range" min="1" max="500" value="' + awidth + '" name="chang" /></label>' + '<label>高 <input type="range" min="1" max="500" value="' + aheight + '" name="kuan" /></label>';
            ...
            odiv.innerHTML = '<label>大小 <input type="range" min="1" max="200" value="' + awidth + '" name="chang" /></label><label>文字 <input type="text" maxlength="30" value="' + atext + '" name="kuan" /></label>';
        }
